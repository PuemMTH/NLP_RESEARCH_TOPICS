...
- **DIAGRAM FIRST**: Whenever a pipeline, system architecture, flow, or comparison is discussed — write a Mermaid diagram block in the response AND save the `.md` file to `research/diagrams/<slug>.md` for future reference.
...
2. Write the Mermaid diagram block in the response
