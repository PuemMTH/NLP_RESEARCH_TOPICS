...
## Subtopics
- Public health surveillance NLP (ontology, corpus, event-spatial understanding)
- Agriculture and e-government decision support systems
- Thai NLP applications and education analytics
- Myanmar NLP and speech technologies

## Citation Snapshot (from user table)
- Total entries: 19
- Total citations shown: 114
- Most-cited work: 2018 at-risk student prediction model (25 cites)
